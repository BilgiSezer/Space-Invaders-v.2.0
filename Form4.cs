...
namespace Space_İnvaders_v._1._0
{
    public partial class Form4 : Form
    {
        ...
        public int deger = 0;
        public int zaman = 60;
        public static int puan = Form1.puan;
        ...
        private void Form4_Load(object sender, EventArgs e)
        {
            ...
            if (Form2.resim == "4")
                gemiresmi.ImageLocation = (Application.StartupPath + "\\resimler\\4.jpg");
            if (Form2.resim == "5")
        ...
        private void atlar_Tick(object sender, EventArgs e)
        {
            ...
            cancubuk.CreateGraphics().DrawString(can.ToString() + " Can", new Font("Arial Bold", (float)12, FontStyle.Regular), Brushes.Black, new PointF(cancubuk.Width / 2 - 10, cancubuk.Height / 2 - 7));
